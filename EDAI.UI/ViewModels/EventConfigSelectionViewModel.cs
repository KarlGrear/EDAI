...
public sealed partial class EventConfigSelectionViewModel : ObservableObject
{
    ...
    private async Task ImportConfig()
    {
        ...
        var newConfig = new EventConfigurationModel
        {
            ...
            TriggerTimeoutMs     = payload.TriggerTimeoutMs,
